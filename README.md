# <img src="/public/images/logo.svg" height="60" valign="middle" alt="TAC Safe" style="background: #fff; padding: 20px; margin: 0 -20px" />
...
TAC Safe is a smart contract wallet for Ethereum and other EVM chains. Based on Gnosis Safe multisig contracts.

This repository is the frontend of the TAC Safe app.
